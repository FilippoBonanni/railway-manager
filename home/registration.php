...
<body>
    ...
    <div class="content d-flex justify-content-center align-items-center">
        <div class="search-container registration-container">
            <h1>Registrazione</h1>
            <form class="row" action="../scripts/register_user.php" method="POST">
                <!-- First name -->
                ...
                <!-- User type -->
                <div class="form-group col-6">
                    <label for="tipoUtente">Seleziona tipo di utente</label>
                    <select id="tipoUtente" name="tipoUtente">
                        ...
                        <option value="Backoffice Amministrativo">Backoffice Amministrativo</option>
                        <option value="Backoffice Esercizio">Backoffice Esercizio</option>
                    </select>
                </div>
